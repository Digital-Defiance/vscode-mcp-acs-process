...
code --uninstall-extension DigitalDefiance.mcp-acs-process || echo "Extension not installed or already uninstalled"

echo "🔨 Compiling extension..."
yarn compile

echo "📦 Packaging extension..."
VSIX_FILE="mcp-acs-process-reinstall-$(date +%Y%m%d-%H%M%S).vsix"
